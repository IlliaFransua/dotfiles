return {
  ...
  opts = {
    ...
    indent = { enable = true, disable = { "ruby" }}, ---@type lazyvim.TSFeat
    highlight = { enable = true, additional_vim_regex_highlighting = { "ruby" } }, ---@type lazyvim.TSFeat
    folds = { enable = true }, ---@type lazyvim.TSFeat
    auto_install = true,
       incremental_selection = {
	       enable = true
	       -- keymaps = {
	       --   init_selection = "<C-CR>", -- Ctrl+Enter (start selection (by AST node))
	       --   node_incremental = "<C-j>", -- Ctrl+j (expend throught the tree)
	       --   node_decremental = "<C-k>", -- Ctrl+k (step back)
	       -- },
	     },
  },
